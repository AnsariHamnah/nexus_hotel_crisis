  ...
  void _handleLogin() async {
    ...
    try {
      ...
      if (email.isEmpty || password.isEmpty) {
        throw Exception("Please enter both ID and Access Key.");
      }

      // In production, we use Firebase Auth with email/password
      // The labels are aesthetic (Personnel ID -> Email, Access Key -> Password)
      await _authService.loginWithEmailPassword(email, password);
      
      // Navigation is handled automatically by AuthWrapper's StreamBuilder
    } catch (e) {
      if (mounted) {
        setState(() {
                    ...
                    children: [
                          ...
                          children: [
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                const SizedBox(height: 4),
                                _buildInput(_emailController, 'RN-XXXX-000', Icons.fingerprint, false),
                                ...
                                const SizedBox(height: 4),
                                _buildInput(_passwordController, '••••••••••••', Icons.vpn_key, true),
                                if (_error != null) ...[
                                  const SizedBox(height: 8),
                      ...
                      InkWell(
                        ...
                        child: Container(
                          ...
                          child: Row(
                            children: [
                              Container(width: 8, height: 64, color: const Color(0xFFB6171E)), 
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: isSelected ? [const BoxShadow(color: textOnSurface, offset: Offset(4, 4))] : [],
        ),
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
